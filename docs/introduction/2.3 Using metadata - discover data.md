...
- Conduct comparative or secondary analysis on an existing dataset
...
- Identify secondary data for a new research project
- Help produce materials such as policy briefings

How do we go about finding data? 

!!! abstract ""
    :mag: Imagine you're a social science researcher looking at population and climate. You want to conduct research on improving water quality in cities in the UK. You're considering working from secondary data and you want to find open data from the years 2000-2025 that relate to this subject.
...
??? info "You can explore data catalogues for different disciplines below"
...
!!! abstract ""
    ...
    :mag: As this social science researcher, find a data catalogue that could support your research on population, climate, and water quality.
...
!!! abstract ""
    :mag: Continuing in your role as a social science researcher, explore the UK Data Service and try locating relevant research projects connected to your brief. What tools do you use to find relevant research projects?
...
Data catalogues and repositories will often specify what metadata people need to provide when they deposit their data. By standardising the metadata requirements, the same level of information is available for each study on the site. This makes it possible to search and compare easily. We will explore other tools that are used to standardise metadata on data catalogues in the upcoming units [2.4](<2.4 Controlled vocabularies.md>) and [2.5](<2.5 Metadata standards.md>).
...
On CLOSER Discovery, you can also find metadata for an individual question. For example, the variable ['How interested you are in Politics'](https://discovery.closer.ac.uk/item/uk.iser.ukhls/2f1e27ba-e2e9-4bfe-a814-fa54809a77c9) from the WAVE 7 of Understanding Society study, <sup>[6]</sup>. This gives us information about any linked variables to the question, where it appears in the questionnaire, how the participant could respond as well as the topics it relates to. 
...
Once you have found the data, understood the research and assessed its trustworthiness and relevance to your work, you can now decide what you want to do with it. There are lots of different actions you might want to take. 
