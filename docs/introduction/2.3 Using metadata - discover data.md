...
!!! example ""
    ...
    **Intended Learning Outcome**
    ...
    - Recognise how we use metadata to carry out research activites and 'act on' data
...
In our everday lives, we use metadata to discover resources  all the time. Can you think of any examples?
...
=== "**Data repository**" 
    ...
    The UK Data Service describes a data repository as _'a centralised database system that collects, manages, and stores datasets for later use'_.<sup>[1]</sup> They are designed for the long-term storage of datasets which can then be managed and accessed through the repository. There might be some functionality to search the repository but this tends to be limited compared to data catalogues.
=== "**Data catalogue** " 
...
??? info "You can explore data catalogues for different dsicplines below"
...
!!! abstract ""
    ...
    Let's try using a data catalogue to find data.
    
    As this social science researcher, use the websites provided above to identify a data catalogue that could support your research on population, climate, and water quality.
...
!!! abstract ""
    Continuing in your role as a social science researcher, explore the UK Data Service and try locate relevant research projects connected to your brief. What tools do you use to find relevant research projects?
...
<details>
<summary><b>Check if you got the same researh projects as listed in the box</b></summary>
<p></p> 
...
Data catalogues and repositories will often specify what metadata people need to provide when they deposit their data. By standardising the metadata requirements, the same level of information is available for each study on the site. This makes it possible to search and compare easily. We will explore other tools that are used to standardise metadata in the upcoming units [2.4](<2.4 Controlled vocabularies.md>) and [2.5](<2.5 Metadata standards.md>).
...
- You review metadata for an individual variable, such as the data type and linked questions, on UK Data Service Variable and Question Bank. For example, Variable ['Past health problems - 5'](https://discover.ukdataservice.ac.uk//variables/variable/?id=9323_V230) <sup>[3]</sup>
...
For example, the 2024 research project ["Dietary Intake in Scotland's CHildren (DISH)"](https://datacatalogue.ukdataservice.ac.uk/studies/study/9370#documentation) has a Codebook and Data Dictionary available to download in the 'Documentation' tab on the UK Data Service.
...
=== "**Data dictionaries**"
    ...
    The data dictionary for the DISH project lists the different variables in a survey and a short label to describe the variable. It contains more high level information than a codebook as it does not include information such as unit of measurement, codes or categories used.
