...
??? info "You can explore data catalogues for different disciplines below"
    - [ICPSR](https://www.icpsr.umich.edu/sites/icpsr/home) - offers metadata for social and behavioural science datasets
...
??? info "Check if you got the same research projects as listed in the box"
...
- [**&larr; Previous <p></p> Unit 2.2 Metadata in the research lifecycle**](<2.2 Metadata in the research lifecycle.md>)
- [**Next &rarr; <p></p> Unit 2.4 Controlled vocabularies**](<2.4 Controlled vocabularies.md>)
