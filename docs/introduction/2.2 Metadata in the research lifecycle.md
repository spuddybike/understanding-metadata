...
- When do you use metadata in research lifecycle
...
### Using metadata: Research Design and Data Collection stages
...
You can see an example of good data provenance for derived variables in the [National Child Development Study](https://discovery.closer.ac.uk/item/uk.cls.ncds/524c8f92-493f-4660-90c4-0aa7ac3d2640/141) on Closer Discovery. 
...
- [**&larr; Previous <p></p> Unit 2.1 Introduction to metadata**](<2.1 Introduction to metadata.md>)
- [**Next &rarr; <p></p> Unit 2.3 Using metadata: discover, understand, assess and act on**](<2.3 Using metadata - discover.md>)
