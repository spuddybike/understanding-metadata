...
You can see an example of good data provenance for derived variables for the [National Child Development Study<sup>[6]</sup>](https://discovery.closer.ac.uk/item/uk.cls.ncds/524c8f92-493f-4660-90c4-0aa7ac3d2640/141) on Closer Discovery<sup>[7]</sup>. For example, examine the following variables...
...
Through exploring the tabs on the variable webpage we can find ...
