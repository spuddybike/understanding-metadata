...
## References
- <sup>[1]</sup>: CODATA (2025) RDM Terminology Bank: [Standardisation](ttps://terms.codata.org/rdmt/standardisation)
...
- <sup>[10]</sup>: CODATA (2025) RDM Terminology Bank: [Ontology](https://terms.codata.org/rdmt/onotology)
