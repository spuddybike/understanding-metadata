...
**What are some of the current issues in the metadata?**
...
!!! quesiton "What controlled vocabularies could we use for the 'Original language', 'Language', and 'Genre' metadata?"
