...
!!! quote "From a research data management perspective, CODATA define [standardisation]([https://terms.codata.org/rdmt/metadata-standard](https://terms.codata.org/rdmt/standardisation) as..."
...
!!! quote "CODATA defines [controlled vocabularies](]([https://terms.codata.org/rdmt/metadata-standard](https://terms.codata.org/rdmt/controlled-vocabulary) as..."
...
The image below describes how the strength of semantics relate to different systems.<sup>[9]</sup> Strong semantics refer to systems that are more detailed in describing the relationships between terms and their meaning.
...
=== "Ontologies"
    ...
    !!! quote "CODATA defines an ontology as..."
        ...
        _'Shared and standardised list of words, terms and phrases to describe components of a particular discipline or domain, along with a taxonomy of their relations... Ontologies are typically developed by domain-specific institutions or communities to aid in the precise referencing of elements.'_<sup>[5]<sup>
    ...
    - [PROV-O: The PROV Ontology](https://www.w3.org/TR/prov-o/) can be used to represent and interchange provenance information generated in different systems and under different contexts.<sup>[11]</sup>
    - [Ontology for General Medical Science](https://bioportal.bioontology.org/ontologies/OGMS?p=summary) describes entities involved in a clinical encounter and common general terms such as, 'disease', 'disorder', 'disease course', 'diagnosis', 'patient', and 'healthcare provider'. <sup>[12]</sup>
...
- <sup>[4]</sup>: [ISO 639-1/639-3](https://iso639-3.sil.org/code_tables/639/data)
- <sup>[5]</sup>: [ISO 3166-1 Alpha-2 Country Codes](https://www.iso.org/obp/ui/#search)
...
- <sup>[10]</sup>: CODATA (2025) RDM Terminology Bank: [Ontology]([https://terms.codata.org/rdmt/metadata-standard](https://terms.codata.org/rdmt/onotology)
- <sup>[11]</sup>: [PROV-O: The PROV Ontology](https://www.w3.org/TR/prov-o/)
- <sup>[12]</sup>: JCVI (2025) [OGMS: Ontology for General Medical Science](https://www.jcvi.org/research/ogms-ontology-general-medical-science)
