...
In this unit, we'll look at creating **study level metadata**. 

**Creating metadata for a study**

As we explored in [unit 2.5](<2.4 Metadata standards.md>), it is useful to follow a metadata standard or schema when creating metadata. It helps us ensure our metadata is consistent and interoperable as well as saves us time in creating a clear structure.
