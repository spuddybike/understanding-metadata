...
We have covered the role of metadata in research and how we _use_ it. In this unit, we'll explore _creating_ metadata.
...
- <sup>[3]</sup> Steffel, N. (2015) Simple Generator [A JavaScript/JQuery tool for working with Dublin Core metadata code.](https://nsteffel.github.io/dublin_core_generator/generator_nq.html)
