...
In this unit, we'll look at creating **study level metadata**. If you're sharing your research, study level metadata gives others a clear overview of what your research is about and how it was produced. If your research is for personal reference only, study level metadata helps you document your research in your files so you can revisit it in the future.

**Creating metadata for a research project**

As we explored in [unit 2.5](<2.4 Metadata standards.md>), it is useful to follow a metadata standard or schema when creating metadata. It helps us ensure our metadata is consistent and interoperable as well as save us time in creating a clear structure.
