...
- Explain the four FAIR principles (Findable, Accessible< Interoperable, Re-usable)
- Understand the role of FAIR in research and it's benefits
- Identify research activities and research tools to implement FAIR
...
Everyone can contribute to the implementation of FAIR data. Within the research field, infrastructures help enable the practice of FAIR data. These include data repositories, data catalogues, standards, data guidelines and software to manage and store data. We will explore some of these tools in the later units. As someone creating or engaging with research data, you can also pracitice FAIR in your work.
