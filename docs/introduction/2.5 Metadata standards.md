...
!!! info "A case study on standardisation: USB-C chargers"
    ...
    Just like these examples of standardisation, metadata standards in research ensure consistency, interoperability and reuse. Without them, metadata, and consquently the data it's describing, becomes siloed and difficult to integrate.
...
**Facilitate integration ino data catalogues and repositories**
...
=== abstract ""
    ...
    For example, have a look at these cross-study comparisons below. Each study uses the same metadata standard, DDI. This means the studies can be integrated ino the same data catalogues, the [UK Data Service](https://ukdataservice.ac.uk/find-data/browse/) and [CLOSER Discovery](https://discovery.closer.ac.uk/). This then allows researchers to discover data on these sites and easily compare different areas of the study so they can draw new findings.
...
here  compile metadata standards across disciplines and allow you to search for the standard most relevant to your research.

You can  sites include...

- [Metadata standards catalogue](https://rdamsc.bath.ac.uk/subject-index) which compile metadata standards across disciplines and allow you to search for the standard most relevant to your research.
