...
!!! tip "**Facilitate data sharing and collaboration**"
    ...
    FAIRwDDI project outline the benefit of metadata standards and using Document Data Initiative (DDI) in social science research. Below they provide an example of how standards help avoid confusion and inconsistency in creating metadata.<sup>[4]</sup>
...
- <sup>[4]</sup>: CDSP and CLOSER (2025) 'DDI Metadata Made Simple: Your Top Questions Answered' _FAIRwDDI_ (to be released)
...
- (https://learning.closer.ac.uk/researchcasestudies/the-rise-of-the-obesity-epidemic/)
