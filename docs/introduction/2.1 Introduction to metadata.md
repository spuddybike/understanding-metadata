...
With that information, you'd feel more confident about what’s inside the can and whether you want to drink it. You'd also trust it more if you find it in a shop with other similar drinks as the shop adds credibility because you trust them to stock genuine products. Plus, you can compare labels of other products and make an informed choice about which drink to pick.
...
!!! quote "According to CODATA, [metadata](https://terms.codata.org/rdmt/metadata) is ..."
	...
	_'Data about data. It is data (or information) that defines and describes the characteristics of other data. It is used to improve the understanding and use of the data.' <sup>[2]</sup>_

!!! quote "The National Information Standards Organization offers a similar definition ..."

	_'Metadata is structured information that describes, explains, locates, or otherwise makes it easier to retrieve, use, or manage an information resource. Metadata is often called data about data or information about information.' <sup>[3]</sup>_
...
When identifying relevant secondary data for your project, you come across this dataset below <sup>[4]</sup>. You need to determine whether it would be useful for your research.
...
You can find study level metadata for the unlabelled dataset [on CLOSER Discovery.](https://discovery.closer.ac.uk/Item/uk.cls.ncds/524c8f92-493f-4660-90c4-0aa7ac3d2640/).<sup>[5]</sup> CLOSER Discovery is a metadata catalogue that pulls together metadata from different studies in one place, so people can search and find research (we will cover data and metadata catalogues in more detail in [unit 2.3](<2.3 Using metadata - discover metadata.md>). As this is a longitudinal study, there is also metadata

Using the study metadata available on CLOSER Discovery, try answering some of the questions above.

We know the study was conducted across England, Scotland and Wales and produced as part of the National Child Development Study.<sup>[6]</sup>
...
You can explore dataset level metadata for the unlabelled dataset [on CLOSER Discovery here](https://discovery.closer.ac.uk/item/uk.cls.ncds/a52ee654-efa8-4839-a545-fd82bec63e71)<sup>[7]</sup>.
...
!!! quote "Variable definition"
    _Variable is a characteristic of a unit being observed. A variable might be the answer of a question, have an administrative source, or be derived from other variables._ <sup>[8]</sup>
...
Information about the data can be found [on CLOSER Discovery here](https://discovery.closer.ac.uk/item/uk.cls.ncds/b3909a8c-2118-4f82-ad34-245ce610ea07).<sup>[9]</sup> You can select different variables to gain insight into what data they collect. 
...
Metadata about the survey [can be explored here](https://discovery.closer.ac.uk/item/uk.cls.ncds/b8698e54-0501-46e4-962c-cf6e2906fe8e/)<sup>[10]</sup>.
...
The guidelines below explore how to make both our data and metadata FAIR<sup>[15]</sup>...
...
- You can watch [this knowledge clip from UGent University](https://www.youtube.com/watch?v=DW2T_cnqKPU) to gain an overview of metadata in a research context<sup>[16]</sup>
- You can explore CESSDA's explanation of metadata for [qualitative and quantative metadata here](https://dmeg.cessda.eu/Data-Management-Expert-Guide/2.-Organise-Document/Documentation-and-metadata)<sup>[17]</sup>
...
- <sup>[2]</sup> CODATA (2025) RDM Terminiology: [metadata](https://terms.codata.org/rdmt/metadata)
- <sup>[3]</sup> Riley, J. (2017) ['Understanding metadata: what is metadata, and what is it for?']((http://www.niso.org/publications/press/UnderstandingMetadata.pdf)) _National Information Standards Organization._ Baltimore.
...
- <sup>[5]</sup> CLOSER (2025) ['National Child Development Study' _CLOSER Discovery_](https://discovery.closer.ac.uk/Item/uk.cls.ncds/524c8f92-493f-4660-90c4-0aa7ac3d2640/)
- <sup>[6]</sup> University of London, Institute of Education, Centre for Longitudinal Studies. (2024). _National Child Development Study: Childhood Data from Birth to Age 16, Sweeps 0-3, 1958-1974._ [data collection]. 3rd Edition. National Children's Bureau, National Birthday Trust Fund, [original data producer(s)]. UK Data Service. SN: 5565, DOI: http://doi.org/10.5255/UKDA-SN-5565-2
- <sup>[7]</sup> CLOSER (2025) ['Age 11 Survey (1969)' _CLOSER Discovery_](https://discovery.closer.ac.uk/item/uk.cls.ncds/a52ee654-efa8-4839-a545-fd82bec63e71)
- <sup>[8]</sup> CODATA (2025) RDM Terminology Bank: [Variable](https://rdf-vocabulary.ddialliance.org/discovery.html#variable-and-variable-definition)
- <sup>[9]</sup> CLOSER (2025) ['NCDS2 Parental Interview Form (1969) Dataset' _CLOSER Discovery_](https://discovery.closer.ac.uk/item/uk.cls.ncds/a52ee654-efa8-4839-a545-fd82bec63e71)
- <sup>[10]</sup> CLOSER (2025) ['NCDS Age 11 Parental Interview Form' _CLOSER Discovery_](https://discovery.closer.ac.uk/item/uk.cls.ncds/b8698e54-0501-46e4-962c-cf6e2906fe8e/)
- <sup>[11]</sup> Parliament of the Czech Republic (2009) [ACT No. 130/2002 Coll. on the Support of Research and Development from Public Funds and on the Amendment to Some Related Acts](https://vyzkum.gov.cz/FrontClanek.aspx?idsekce=15607) _Czech Republic_
- <sup>[12]</sup> Ministry of Foreign Affairs of the Czech Republic (2020) ['Key Documents on Czech Research and Innovation'](https://mzv.gov.cz/jnp/en/foreign_relations/science_and_technology/key_documents_on_czech_research_and.html)
- <sup>[13]</sup> CODATA (2025) RDM Terminiology: [Research data management](https://terms.codata.org/rdmt/research-data-management)
- <sup>[14]</sup> CODATA (2025) RDM Terminiology: [FAIR data](https://terms.codata.org/rdmt/fair-data)
- <sup>[15]</sup>[Go FAIR (2025) FAIR Principles](www.go-fair.org/fair-principles/)
- <sup>[16]</sup> UGent University (2021) Open Science Knowledge clip: Metadata [Online video] www.youtube.com/watch?v=DW2T_cnqKPU) 
- <sup>[17]</sup> CESSDA (2025) 'Documentation and Metadata' Data Management Expert Guide www.dmeg.cessda.eu/Data-Management-Expert-Guide/2.-Organise-Document/Documentation-and-metadata
