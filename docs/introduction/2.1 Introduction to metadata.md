...
Information about the data can be found [on CLOSER Discovery here](https://discovery.closer.ac.uk/item/uk.cls.ncds/b3909a8c-2118-4f82-ad34-245ce610ea07).<sup>[12]</sup> You can select different variables to gain insight into what data they collect. 
...
- You can explore CESSDA's explanation of metadata for [qualitative and quantative metadata here](https://dmeg.cessda.eu/Data-Management-Expert-Guide/2.-Organise-Document/Documentation-and-metadata)<sup>[22]</sup>
...
- <sup>[11]</sup> DDI Alliance (2025) [DDI-RDF Discovery Vocabulary (Disco)](https://rdf-vocabulary.ddialliance.org/discovery.html#variable-and-variable-definition)) World Wide Wive Consortium (WC3) 
...
- <sup>[18]</sup> CODATA (2025) RDM Terminiology: [Research data management](https://terms.codata.org/rdmt/research-data-management)
- <sup>[19]</sup> CODATA (2025) RDM Terminiology: [FAIR data](https://terms.codata.org/rdmt/fair-data)
