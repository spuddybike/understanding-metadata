...
You can find study level metadata for the unlabelled dataset [on CLOSER Discovery.](https://discovery.closer.ac.uk/Item/uk.cls.ncds/524c8f92-493f-4660-90c4-0aa7ac3d2640/).<sup>[7]</sup> CLOSER Discovery is a metadata catalogue that pulls together metadata from different studies in one place, so people can search and find research (we will cover data and metadata catalogues in more detail in [unit 2.3](<2.3 Using metadata - discover metadata.md>). As this is a longitudinal study, there is also metadata
...
You can explore dataset level metadata for the unlabelled dataset [on CLOSER Discovery here](https://discovery.closer.ac.uk/item/uk.cls.ncds/a52ee654-efa8-4839-a545-fd82bec63e71)<sup>[9]</sup>.
...
!!! quote "Variable definition"
    _Variable is a characteristic of a unit being observed. A variable might be the answer of a question, have an administrative source, or be derived from other variables._ <sup>[10]</sup>
...
Information about the data can be found [on CLOSER Discovery here](https://discovery.closer.ac.uk/item/uk.cls.ncds/b3909a8c-2118-4f82-ad34-245ce610ea07).<sup>[11]</sup> You can select different variables to gain insight into what data they collect. 
...
Metadata about the survey [can be explored here](https://discovery.closer.ac.uk/item/uk.cls.ncds/b8698e54-0501-46e4-962c-cf6e2906fe8e/)<sup>[12]</sup>.
...
Consider these two descriptions of a dataset.<sup>[13]</sup>
...
- **Description two**  
    Description two is available online on a data catalogue site <sup>[14]</sup> (we will cover data catalogues in more depth in [unit 2.3](<2.3 Using metadata - discover data.md>)).
    <p></p>
...
- You can watch [this knowledge clip from UGent University](https://www.youtube.com/watch?v=DW2T_cnqKPU) to gain an overview of metadata in a research context<sup>[20]</sup>
- You can explore CESSDA's explanation of metadata for [qualitative and quantative metadata here](https://dmeg.cessda.eu/Data-Management-Expert-Guide/2.-Organise-Document/Documentation-and-metadata)<sup>[21]</sup>
...
- <sup>[11]</sup> CLOSER (2025) ['NCDS2 Parental Interview Form (1969) Dataset' _CLOSER Discovery_](https://discovery.closer.ac.uk/item/uk.cls.ncds/a52ee654-efa8-4839-a545-fd82bec63e71)
- <sup>[12]</sup> CLOSER (2025) ['NCDS Age 11 Parental Interview Form' _CLOSER Discovery_](https://discovery.closer.ac.uk/item/uk.cls.ncds/b8698e54-0501-46e4-962c-cf6e2906fe8e/)
- <sup>[13]</sup> University of London, Institute of Education, Centre for Longitudinal Studies. (2024). _National Child Development Study: Childhood Data from Birth to Age 16, Sweeps 0-3, 1958-1974._ [data collection]. 3rd Edition. National Children's Bureau, National Birthday Trust Fund, [original data producer(s)]. UK Data Service. SN: 5565, DOI: http://doi.org/10.5255/UKDA-SN-5565-2
- <sup>[14]</sup>
- <sup>[15]</sup> Parliament of the Czech Republic (2009) [ACT No. 130/2002 Coll. on the Support of Research and Development from Public Funds and on the Amendment to Some Related Acts](https://vyzkum.gov.cz/FrontClanek.aspx?idsekce=15607) _Czech Republic_
- <sup>[16]</sup> Ministry of Foreign Affairs of the Czech Republic (2020) ['Key Documents on Czech Research and Innovation'](https://mzv.gov.cz/jnp/en/foreign_relations/science_and_technology/key_documents_on_czech_research_and.html)
- <sup>[17]</sup> CODATA (2025) RDM Terminiology: [Research data management](https://terms.codata.org/rdmt/research-data-management)
- <sup>[18]</sup> CODATA (2025) RDM Terminiology: [FAIR data](https://terms.codata.org/rdmt/fair-data)
- <sup>[19]</sup>[Go FAIR (2025) FAIR Principles](www.go-fair.org/fair-principles/)
- <sup>[20]</sup> UGent University (2021) Open Science Knowledge clip: Metadata [Online video] www.youtube.com/watch?v=DW2T_cnqKPU) 
- <sup>[21]</sup> CESSDA (2025) 'Documentation and Metadata' Data Management Expert Guide www.dmeg.cessda.eu/Data-Management-Expert-Guide/2.-Organise-Document/Documentation-and-metadata
