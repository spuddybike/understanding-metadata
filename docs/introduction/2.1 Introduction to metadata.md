...
You can find study level metadata for the unlabelled dataset [on CLOSER Discovery.](https://discovery.closer.ac.uk/Item/uk.cls.ncds/524c8f92-493f-4660-90c4-0aa7ac3d2640/).<sup>[7]</sup> CLOSER Discovery is a metadata catalogue that pulls together metadata from different studies in one place, so people can search and find research (we will cover data and metadata catalogues in more detail in [unit 2.3](<2.3 Using metadata - discover data.md>). As this is a longitudinal study, there is also metadata
