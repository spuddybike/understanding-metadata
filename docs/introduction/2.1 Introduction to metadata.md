...
In the following units, we look further into how we can implement this guidance using data repositories and catalogues [unit 2.3](<2.3 Using metadata%3A%20discover data.md>)), controlled vocabularies ([unit 2.4](<2.4 Controlled vocabularies.md>) and metadata standards ([unit 2.5](<2.5 Metadata standards.md>)).
