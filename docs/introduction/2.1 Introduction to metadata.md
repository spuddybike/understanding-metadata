...
With all that information, you'd feel more confident about what’s inside the can and whether you want to drink it. You'd also trust it more if you find it in a shop with other similar drinks as the shop adds credibility because you trust them to stock genuine products. Plus, you can compare labels of other prodcuts and make an informed choice about which drink to pick.<sup>[1]</sup>
