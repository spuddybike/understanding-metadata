...
You can find study level metadata for the unlabelled dataset [on CLOSER Discovery.](https://discovery.closer.ac.uk/Item/uk.cls.ncds/524c8f92-493f-4660-90c4-0aa7ac3d2640/63). CLOSER Discovery is a metadata catalogue that pulls together metadata from different studies in one place, so people can search and find research. We will cover data and metadata catalogues in more detail in [unit 2.4](<2.4 Using metadata - discover metadata.md>). 
