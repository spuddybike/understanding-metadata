...
<img src="../img/Ldn-apple-weather.jpg" alt="Alt Text" width="325" height="700">

<details>
<summary><b>Data on the weather app</b></summary>
<p></p>

<img src="../img/weatherdatacircled1.png" alt="Alt Text" width="325" height="700"> 
<p></p>
...
We can also interpret the same information about the same concept using different _representations of data_.

We can gain information about cloud coverage through the following representations of data...
...
Data doesn't come in one set format. Instead, there are different _representations of data_ which can convey the same information. By interpreting these representations, we gain meaning from the data. <sup>[1]</sup>['University of Cambridge (2025) What is research data?'](www.data.cam.ac.uk/about/what)
...
!!! quote "CODATA conceives data as..."
...
!!! quote "CODATA defines research data as..."
...
We then use a **representation** to record individual measurements of the concept. This is our research data.
...
You may want to collect data for a research activity that involves knowing the age of every participant in a study.
...
Thinking back to the weather app, identify the concept &rarr; measure &rarr; data of the data collected on the app.
...
Try identify the concept &rarr; measure &rarr; data for your research.
...
- [**&larr; Previous**](<1.0 Module Introduction.md>)<p></p> Getting started
- [**Next &rarr;**](<1.2 Research data management.md>)<p></p> Unit 1.2 Research data management
