...
!!! abstract ""
    ...
    ??? question "How would we represent that **data**?"
        ...
        We could use years, months, days, minutes or seconds to record data about age. If we used one of these units of measurement, we would create _numeric_ data. If we use years as a unit of measurement, the valid range of numbers that would be acceptable would start from 0 (as your age cannot be in minus numbers) to roughly 115, based on the average lifespan of a person. The numeric data collected in our research will make up our dataset.
