...
Data doesn't come in one set format. Instead, there are different _representations of data_ which can convey the same information. By interpreting these representations, we gain meaning from the data. <sup>[1]</sup>
