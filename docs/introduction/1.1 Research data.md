...
In this weather app example, we gain information about the _measurement_ of weather conditions in London by interpreting the data. We interpret different types of data to do this.
