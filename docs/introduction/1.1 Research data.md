...
-   <div class="card small-card" markdown>
    [**← Previous**](<1.0 Module Introduction.md>)
    [Getting started](<1.0 Module Introduction.md>)
    </div>
-   <div class="card small-card" markdown>
    [**Next →**](<1.2 Research data management.md>)  
    [Unit 1.2 Research data management](<1.2 Research data management.md>)
    </div>
</div>
...
'Something in the world' is the **concept** we are researching. To record it, we **measure** the concept. Through measuring the concept, we produce our **research data**.
...
<div class="grid cards" markdown>
- [**&larr; Previous <p></p> Getting started**](<1.0 Module Introduction.md>)
- [**Next &rarr;<p></p> Unit 1.2 Research data management**](<1.2 Research data management.md>)
