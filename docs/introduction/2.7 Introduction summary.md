...
Metadata is not a nice-to-have, it is an asset that can be used to your advantage, making your data go further and maximising the potential of research. Metadata plays a key role in FAIR data, a standard to which the research community are working towards. As such, funders, insitutions or journals may require you to create metadata as part of your research.
