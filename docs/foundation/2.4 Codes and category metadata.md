...
- You will not know what codes mean and will have to either guess or undertake time-consuming processes such as contacting the data creator
...
The meanings of codes are called categories. Categories assign meaning to the codes.
...
- [ONS CENSUS 2021 - Ethnic group](https://www.ons.gov.uk/census/census2021dictionary/variablesbytopic/ethnicgroupnationalidentitylanguageandreligionvariablescensus2021/ethnicgroup)
- [Publications Office of the European Union - Family relationships](https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://data.europa.eu/snb/family-relationship/78df67z)
...
!!! question ""
    ...
    **Which of the following is an example of a code and its category?**
    ...
    ??? success "Reveal answer"
        ...
        1 = Male, 2 = Female. Codes (e.g. 1, 2) are linked to categories (e.g. Male, Female) to make data interpretable.
    ...
    **Two datasets use different coding schemes for the same concept (e.g. 0/1 vs 1/2). What should you do before combining them?**
    ...
    ??? success "Reveal answer"
        ...
        Recode values to ensure consistency. Coding differences must be reconciled (harmonised) to ensure valid comparison or integration.


    **How do codes and category metadata relate to question and measurement metadata?**
    
    1. They provide the representation of collected information in the data
    ...
    ??? success "Reveal answer"
        ...
        They provide the representation of collected information in the data. Measurement metadata defines what is being measured, while codes and categories show how those measurements are represented in the dataset.

## Resources
You can find controlled vocabulary resources on the [Resources page](<../resources.md#research-data-management>).

## References

- [1] CODATA (2025) RDM Terminology Bank: [Persistent identifier](https://terms.codata.org/rdmt/persistent-identifier)
- DDI Training Group (2021) Representations – Codes and Categories. https://doi.org/10.5281/zenodo.5180593
